...
Generated: `2026-04-12T07:59:37.523Z`
...
CREATE TABLE contacts (
      ...
      , engine_used TEXT, deal_score INTEGER DEFAULT 0, deal_status TEXT DEFAULT 'None', linkedin_url TEXT, linkedin_photo TEXT, linkedin_bio TEXT, ai_enrichment_news TEXT, search_vector TEXT, name_native TEXT, company_native TEXT, title_native TEXT, detected_language TEXT, latitude TEXT, longitude TEXT, location_name TEXT);
...
-- Table: crm_mappings_legacy
CREATE TABLE crm_mappings_legacy (
        user_id INTEGER PRIMARY KEY,
        provider TEXT,
        mapping_json TEXT
      );
...
CREATE TABLE users (
        ...
        workspace_id INTEGER
      , tier TEXT DEFAULT 'personal', phone_number TEXT, avatar_url TEXT, is_formal_confirmed INTEGER DEFAULT 0, bio TEXT);
