  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700">
      <div className="flex justify-between items-end">
        <div>
          <h1 className="text-4xl font-black text-white tracking-widest uppercase mb-2">Intelligence <span className="text-brand-500">Vector Library</span></h1>
        ...
        <div className="flex gap-4">
          <button 
            ...
            className="px-6 py-2.5 bg-gradient-to-r from-brand-600 to-violet-600 hover:shadow-brand-500/40 text-white rounded-xl font-black text-[10px] uppercase tracking-widest flex items-center gap-2 transition-all shadow-lg"
          >
      ...
      <div className="flex flex-col md:flex-row gap-6 items-center justify-between p-6 bg-gray-900/40 rounded-3xl border border-gray-800 backdrop-blur-sm">
        <div className="relative group w-full md:w-96">
          ...
          <input 
            ...
            className="w-full pl-12 pr-4 py-3 bg-black/30 border border-gray-800 rounded-2xl text-sm text-white focus:outline-none focus:border-brand-500/50 transition-all font-medium"
          />
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {loading ? (
          ...
          <div className="col-span-full py-24 text-center border-2 border-dashed border-gray-800 rounded-3xl group">
            <Layout size={64} className="mx-auto text-gray-700 mb-6 group-hover:text-brand-500/50 transition-colors" />
