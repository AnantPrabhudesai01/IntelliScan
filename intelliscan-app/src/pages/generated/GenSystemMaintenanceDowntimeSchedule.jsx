...
<div>
<span className="text-brand-500 font-bold tracking-widest text-xs uppercase mb-2 block">Maintenance Control</span>
...
<button className="bg-primary-container text-on-primary-container px-6 py-2.5 rounded-xl font-bold text-sm flex items-center gap-2 shadow-xl shadow-brand-900/20 active:scale-95 transition-all">
...
<span className="material-symbols-outlined text-brand-400" data-icon="timeline">timeline</span>
...
<button className="text-xs font-bold text-white bg-brand-600 px-3 py-1.5 rounded-lg">M</button>
...
<div className="w-12 bg-brand-500/40 animate-pulse"></div>
...
<label className="text-xs font-bold text-brand-400 uppercase tracking-widest">Start Time</label>
<input className="w-full bg-surface-container border-none rounded-xl text-white px-4 py-3 focus:ring-1 focus:ring-brand-500" type="datetime-local"/>
</div>
<div className="space-y-2">
<label className="text-xs font-bold text-brand-400 uppercase tracking-widest">Expected Duration</label>
<select className="w-full bg-surface-container border-none rounded-xl text-white px-4 py-3 focus:ring-1 focus:ring-brand-500">
...
<label className="text-xs font-bold text-brand-400 uppercase tracking-widest">Impacted Engines</label>
...
<input checked="" className="rounded bg-surface-container-highest border-none text-brand-600 focus:ring-0 w-5 h-5" type="checkbox"/>
<span className="text-sm font-semibold">Gemini</span>
</label>
<label className="flex items-center gap-3 p-4 bg-surface-container rounded-xl cursor-pointer hover:bg-surface-container-high transition-colors">
<input className="rounded bg-surface-container-highest border-none text-brand-600 focus:ring-0 w-5 h-5" type="checkbox"/>
...
<label className="text-xs font-bold text-brand-400 uppercase tracking-widest">Broadcast Message</label>
<span className="text-[10px] text-on-surface-variant">User Visibility: Public</span>
</div>
<textarea className="w-full bg-surface-container border-none rounded-xl text-white px-4 py-3 focus:ring-1 focus:ring-brand-500 placeholder:text-outline/40" placeholder="e.g. System upgrade in progress. OCR results may be delayed by 5-10 minutes..." rows="3"></textarea>
</div>
...
<button className="bg-primary-container text-on-primary-container px-8 py-3 rounded-xl font-bold shadow-xl shadow-brand-900/40" type="submit">Deploy Schedule</button>
</div>
</div>
</form>
</section>
...
<div className="space-y-6">
<h3 className="text-xs font-bold text-brand-400 uppercase tracking-[0.2em]">Maintenance Queue</h3>

<div className="bg-surface-container p-5 rounded-xl border-l-4 border-brand-500 relative group overflow-hidden">
...
<button className="text-[10px] font-bold text-brand-400 hover:underline">Edit</button>
...
<div className="bg-[#1a202c]/50 p-6 rounded-2xl border border-brand-500/10">
<div className="flex items-center gap-2 mb-4">
<span className="material-symbols-outlined text-brand-500 text-lg" data-icon="auto_awesome">auto_awesome</span>
...
<span className="text-brand-400 font-mono">98.2%</span>
</div>
<div className="flex justify-between items-center text-xs">
<span className="text-on-surface-variant">Avg. Scan Latency</span>
<span className="text-brand-400 font-mono">1.4s</span>
</div>
<div className="flex justify-between items-center text-xs">
<span className="text-on-surface-variant">Concurrent Tasks</span>
<span className="text-brand-400 font-mono">842</span>
</div>
</div>
...
<p className="text-[10px] font-bold text-brand-400 uppercase tracking-tighter">Secure Core</p>
