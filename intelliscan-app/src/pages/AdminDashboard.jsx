...
const INITIAL_LOGS = [
  ...
  { time: '14:10:01', type: 'SYS', msg: 'Automated security handshake completed for 402 endpoints.', color: 'text-indigo-400' },
];
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm" onClick={onClose}>
      <div className="bg-[#1a2035] border border-white/10 rounded-2xl overflow-hidden w-full max-w-3xl shadow-2xl" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between p-6 border-b border-white/10">
          <h2 className="text-xl font-bold text-white flex items-center gap-2"><Globe size={18} className="text-indigo-400" /> Global Node Distribution Map</h2>
        ...
        <div className="p-6 grid grid-cols-3 gap-4">
          {[
            { label: 'Throughput', value: '1.2 TB/s', color: 'text-indigo-400' },
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm" onClick={onClose}>
      <div className="bg-[#1a2035] border border-white/10 rounded-2xl p-8 w-full max-w-lg shadow-2xl" onClick={e => e.stopPropagation()}>
          ...
          {[
            ...
            <div key={item.label} className="flex items-center justify-between p-3 bg-white/5 rounded-xl">
              ...
              <div className="text-right">
                ...
                <span className={`ml-2 text-[10px] font-bold ${item.good === true ? 'text-green-400' : item.good === false ? 'text-amber-400' : 'text-indigo-400'}`}>{item.trend}</span>
              </div>
            </div>
          ))}
        </div>
        <button onClick={() => {
          ...
          className="w-full py-3 bg-indigo-600 hover:bg-indigo-700 text-white font-bold rounded-xl transition-all active:scale-95 flex items-center justify-center gap-2">
    ...
    <div className="p-8 space-y-8 max-w-7xl mx-auto w-full">
      ...
      <section className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <div className="md:col-span-2 bg-gray-900 dark:bg-[#161c28] rounded-xl p-8 flex flex-col justify-between relative overflow-hidden group border border-gray-800 dark:border-transparent">
          <div className="absolute -right-12 -top-12 w-48 h-48 bg-indigo-500/10 rounded-full blur-3xl group-hover:bg-indigo-500/20 transition-all duration-500" />
          ...
          <div className="mt-8 flex items-end justify-between relative z-10">
            ...
            <div className="text-right">
              ...
              <p className="text-indigo-400 text-sm font-semibold">Optimized</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-[#1a202c] rounded-xl p-6 flex flex-col border border-gray-200 dark:border-gray-800 shadow-sm">
          ...
          <div className="mt-auto h-2 w-full bg-gray-100 dark:bg-gray-800 rounded-full overflow-hidden">
            <div className="h-full bg-gradient-to-r from-indigo-500 to-indigo-300 w-[99.98%]" />
          </div>
        </div>

        <div className="bg-white dark:bg-[#1a202c] rounded-xl p-6 flex flex-col border border-gray-200 dark:border-gray-800 shadow-sm">
          <div className="flex justify-between items-start mb-6">
            <div className="p-3 bg-indigo-50 text-indigo-600 dark:bg-indigo-900/20 dark:text-indigo-400 rounded-xl"><Activity size={24} /></div>
      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2 space-y-6">
          <div className="flex items-end justify-between px-2">
            ...
            <button onClick={() => setShowMap(true)} className="text-indigo-600 dark:text-indigo-400 text-sm font-semibold hover:underline flex items-center gap-1">
          ...
          <div className="bg-white dark:bg-[#161c28] border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm">
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex gap-4">
                <div className="flex items-center gap-2"><div className="w-3 h-3 rounded-full bg-indigo-500" /><span className="text-xs text-gray-500">OCR-V2</span></div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white dark:bg-[#1a202c] border border-gray-200 dark:border-gray-800 rounded-xl p-6 shadow-sm">
            <h3 className="text-gray-900 dark:text-white font-bold mb-4 flex items-center gap-2 font-headline">
              <Terminal className="text-indigo-600 dark:text-indigo-400" size={20} /> System Logs
          ...
          {/* System Expansion */}
          <div className="bg-gradient-to-br from-indigo-600 to-indigo-800 rounded-xl p-6 text-white relative overflow-hidden group shadow-lg">
            ...
            <p className="text-sm text-indigo-100 relative z-10 mb-6 font-medium">
              {pendingWorkspaces > 0
            ...
            <button onClick={() => setShowScaleReport(true)}
              className="relative z-10 mt-3 w-full py-2 rounded-lg text-xs font-bold text-indigo-100 border border-white/20 hover:bg-white/10 transition-all active:scale-95">
